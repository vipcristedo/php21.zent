<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "vipcristedo3@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "0918273645Aa"; //Mật khẩu của gmail
        $mail->SetFrom("vipcristedo3@gmail.com", "Zent Group"); // Thông tin người gửi
        $mail->AddReplyTo("vipcristedo3@gmail.com","Zent Group");// Ấn định email sẽ nhận khi người dùng reply lại.
